        ...
        <div>
            ...
            <div className="flex gap-4 p-4">
                ...
                <div className="w-3/4 flex flex-col gap-4">
                    ...
                    {/* HERO SECTION */}
                    <div className="relative h-[350px] rounded-xl overflow-hidden border border-white">
                        <div
                        ...
                        {/* Title */}
                        <h1 className="absolute bottom-4 left-4 text-5xl md:text-7xl  font-bold z-0">
                            Seatify..
                        </h1>
                    </div>

                </div>
                <div className="w-1/4 h-90 bg-[#121214] rounded-xl p-4">
                    <h1 className="text-center text-2xl font-bold">Quick Book</h1>
                    <div className="bg-black flex items-center  gap-2 my-2 p-2 rounded-md">
                        <div>
                            <h1 className="bg-gradient-to-r from-red-500 to-orange-500 p-4  px-6 rounded-md">{totalbooking}</h1>
                        </div>
                    ...
                    <div>
                        <Button label="Quick Book"  onClick={() =>
